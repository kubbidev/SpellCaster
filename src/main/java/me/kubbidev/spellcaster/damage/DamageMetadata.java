...
public class DamageMetadata implements Cloneable {
    ...
    public @NotNull List<DamagePacket> getPackets() {
        return this.packets;
    }
    ...
    public boolean isSpellCrit() {
        return this.spellCrit;
    }

    public void setSpellCrit(boolean spellCrit) {
     ...
     * <p>
     * This is an arbitrary positive constant, as SpellCaster and other plugins consider
     ...
     *              spell increasing the damage of the current attack.
