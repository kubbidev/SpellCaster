...
/**
 * Some plugins call "fake" Bukkit events to check for specific restrictions.
 * <p>
 ...
 * <p>
 * The concept of fake events is much more compatible AND resilient than natively implementing specific checks as long as plugins that do
 * fire fake events are handled.
 * <p>
 * Fake events are used very commonly in SpellCaster and other plugins.
 * <p>
 * For instance, to check if a player is able to fight with/target another entity/player before casting the damage method.
 * <p>
