...
public class ProjectileAttackMetadata extends AttackMetadata {
     ...
     * <p>
     * {@link DamageMetadata} only gives information about the attack damage and types while this class also contains info about the
     * damager.
     * <p>
     * Some plugins don't let SpellCaster determine what the damager is so there might be problem with damage/reduction stat application.
     *
     ...
     */
    public ProjectileAttackMetadata(@NotNull DamageMetadata metadata, @NotNull LivingEntity target, @Nullable EntityMetadata attacker,
