...
import me.kubbidev.spellcaster.damage.*;
...
import static me.kubbidev.spellcaster.InternalMethod.isAir;
import static me.kubbidev.spellcaster.InternalMethod.isWeapon;
...
public final class DamageManager implements Listener {
    ...
    public DamageManager(@NotNull SpellCaster plugin) {
        this.plugin = plugin;
    }
     ...
     * @return <code>null</code> if SpellCaster cannot find the attack source, some attack meta otherwise.
     */
    public AttackMetadata findAttack(EntityDamageEvent e) {
        ...
        if (e instanceof EntityDamageByEntityEvent) {
             ...
             *
             * If SpellCaster reaches this portion of the code this means that the attack is with
            ...
            if (damager instanceof LivingEntity) {
                 ...
                 * which means that if a spell makes players shoot multiple arrows,
                 * SpellCaster will use the following lines to monitor the attacks
                 * and the spell will apply WEAPON damage.
                 *
    ...
    public DamageType[] getVanillaDamageTypes(LivingEntity damager, EntityDamageEvent.DamageCause cause, EquipmentSlot hand) {
        ...
        @Nullable EntityEquipment equipment = damager.getEquipment();
